...
df = pd.read_csv("../data/v2/csv/types.csv")
...
# ftabla = open("sqls/types_tabla.sql", "w")
# ftabla.write("CREATE TABLE types\n")
# ftabla.write("    (\n")
...
fdata = open("sqls/types_data.sql", "w")

for fil in range(fils):
    stLinea = "INSERT types VALUES("
#     #print(fil, end=" ")
